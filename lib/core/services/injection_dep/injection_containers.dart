...
Future<void> init() async {
  // Bloc
  sl.registerFactory(() => ReciterBloc(
        reciterDetailUsecase: sl(),
        recitersInfoUsecase: sl(),
        groupedRecitersUsecase: sl(),
      ));
  // Usecases
  ...
  sl.registerLazySingleton(() => GroupedRecitersUsecase(reciterRepository: sl()));
